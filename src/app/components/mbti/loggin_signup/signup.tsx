...
export default function Signup({ handleNext, setStep, setShowSignup, setShowLogin, setShowEmail }: SignupProps): JSX.Element {
...
{/* 
          ...
          {showInvalidEmail && (
              <div className=" mt-[8px] ml-[0px] md:ml-[14px] w-full text-[#E35C5C] text-[14px] font-[Inter] leading-[14px]">
