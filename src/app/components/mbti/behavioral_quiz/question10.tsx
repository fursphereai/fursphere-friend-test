...
const getReactionText = (num: number): string => {
  const reactionOptions = ['Stressed(100%)', 'Stressed(75%)', 'Stressed(50%)', 'Stressed(25%)', '0%', 'Chill(25%)', 'Chill(50%)', 'Chill(75%)', 'Chill(100%)'];
...
const Question10: React.FC<Question10Props> = ({
  handleNext,
  handleBack,
  handleSkip,
  surveyData,
  ...
  const [selectedOption, setSelectedOption] = useState<any>(
    getReactionNumber(surveyData.personality_and_behavior.Structure_Spontaneity.react_new_environment) || 5
  );
  ...
  const handleSelectOption = (option: string) => {
    ...
    updateAnswer('personality_and_behavior', 'Structure_Spontaneity', 'react_new_environment', getReactionText(parseInt(option)));
  };
  ...
  <div className=" mx-auto w-[320px] md:w-[540px] flex flex-row items-center justify-between ">
    ...
    <div className="quiz-container">
      ...
      <div className="question-container h-[38px] md:h-[44px] leading-[19.36px] text-[#101828]">
        <h2>How does your pet react to new environment?</h2>
      </div>
      ...
      <div className="slider-container desktop" style={{ display: isMobile ? 'none' : 'block' }}>
        ...
        <div className="label-row ">
          <span className="option-label text-[14px] text-[#717680]">😖Stressed</span>
          <span className="option-label text-[14px] text-[#717680]">😌Chill</span>
        </div>
      </div>
