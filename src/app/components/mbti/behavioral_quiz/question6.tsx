...
const getReactionText = (num: number): string => {
  const reactionOptions = ['Stinky(100%)', 'Stinky(75%)', 'Stinky(50%)', 'Stinky(25%)', '0%', 'Tidy and Clean(25%)', 'Tidy and Clean(50%)', 'Tidy and Clean(75%)', 'Tidy and Clean(100%)'];
...
const Question6: React.FC<Question6Props> = ({
  handleNext,
  handleBack, 
  handleSkip,
  surveyData,
  ...
  const [selectedOption, setSelectedOption] = useState<any>(
    getReactionNumber(surveyData.personality_and_behavior.Routin_Curiosity.fur_care_7days) || 5
  );
  ...
  const handleSelectOption = (option: string) => {
    ...
    updateAnswer('personality_and_behavior', 'Routin_Curiosity', 'fur_care_7days', getReactionText(parseInt(option)));
  };
