...
const getReactionText = (num: number): string => {
  const reactionOptions = ['Welcomes(100%)', 'Welcomes(75%)', 'Welcomes(50%)', 'Welcomes(25%)', '0%', 'Hides(25%)', 'Hides(50%)', 'Hides(75%)', 'Hides(100%)'];
...
const Question5: React.FC<Question5Props> = ({
  handleNext,
  handleBack,
  handleSkip,
  surveyData,
  ...
  const handleSelectOption = (option: string) => {
    ...
    updateAnswer('personality_and_behavior', 'Routin_Curiosity', 'friend_visit_behaviors', getReactionText(parseInt(option)));
  };
