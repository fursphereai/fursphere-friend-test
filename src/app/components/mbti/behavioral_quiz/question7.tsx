...
const getReactionText = (num: number): string => {
  const reactionOptions = ['Ignores(100%)', 'Ignores(75%)', 'Ignores(50%)', 'Ignores(25%)', '0%', 'Comforts you(25%)', 'Comforts you(50%)', 'Comforts you(75%)', 'Comforts you(100%)'];
...
const Question7: React.FC<Question7Props> = ({
  handleNext,
  handleBack,
  handleSkip,
  surveyData,
  ...
  const [selectedOption, setSelectedOption] = useState<any>(
    getReactionNumber(surveyData.personality_and_behavior.Decision_Making.react_when_sad) || 5
  );
  ...
  const handleSelectOption = (option: string) => {
    ...
    updateAnswer('personality_and_behavior', 'Decision_Making', 'react_when_sad', getReactionText(parseInt(option)));
  };
  ...
  return (
    ...
    <div className="quiz-container">
      ...
      <div className="question-container h-[38px] md:h-[44px] leading-[19.36px]">
        <h2>If you show sadness to your pet, how will his/her react?</h2>
      </div>
      ...
      <div className="slider-container desktop" style={{ display: isMobile ? 'none' : 'block' }}>
        ...
        <div className="label-row ">
          <span className="option-label text-[14px] text-[#717680]">😒Ignores</span>
          <span className="option-label text-[14px] text-[#717680]">🫶🏻Comforts you</span>
        </div>
      </div>
